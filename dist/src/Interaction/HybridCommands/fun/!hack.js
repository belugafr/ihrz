...
export default {
    run: async (client, interaction, lang, command, neededPerm, args) => {
        ...
        let embed = new EmbedBuilder()
            ...
            .addFields({ name: lang.hack_embed_fields_ip, value: `\`${generatedIp}\`` }, { name: lang.hack_embed_fields_email, value: `\`${generatedEmail}\`` }, { name: lang.hack_embed_fields_password, value: `\`${generatedPassword}\`` })
            .setTimestamp();
