    ...
    run: async (client, interaction, lang, command, neededPerm) => {
        ...
        if (!bot_1.bot) {
            ...
            let utils_msg = lang.mybot_submit_utils_msg
                ...
                .replace("${bot_1.bot_public ? 'Yes' : 'No'}", bot_1.bot_public ? lang.mybot_submit_utils_msg_yes : lang.mybot_submit_utils_msg_no);
            let embed = new EmbedBuilder()
                .setColor('#ff7f50')
                .setTitle(lang.mybot_submit_embed_title
                .replace('${bot_1.bot.username}', bot_1.bot.username)
                .replace('${bot_1.bot.discriminator}', bot_1.bot.discriminator))
                .setDescription(lang.mybot_submit_embed_desc
                .replace('${code}', code)
