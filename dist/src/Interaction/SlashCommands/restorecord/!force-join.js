...
export default {
    run: async (client, interaction, lang, command, neededPerm) => {
        ...
        let embed = new EmbedBuilder()
            ...
            .setColor(2829617)
            .setFields({ name: lang.rc_forceJoin_embed_field1, value: String(members.length), inline: true }, { name: lang.rc_forceJoin_embed_field2, value: String(membersAlreadyHere.length), inline: true }, { name: lang.rc_forceJoin_embed_field3, value: String(members.length - membersAlreadyHere.length), inline: true });
        const response = await client.method.interactionSend(interaction, {
            ...
            components: [
                new ActionRowBuilder()
                    ...
                    .setLabel(lang.var_confirm), new ButtonBuilder()
                    .setCustomId("no")
        ...
        collector.on("collect", async (i) => {
            ...
            if (i.customId === "yes") {
                ...
                const updateEmbed = () => {
                    embed.setFields({ name: lang.rc_forceJoin_embed_2_field1, value: String(totalMembers - membersAlreadyHere.length), inline: true }, { name: lang.rc_forceJoin_embed_2_field2, value: String(addedCount), inline: true });
