...
*/
import { EmbedBuilder, ApplicationCommandOptionType, ApplicationCommandType, } from 'discord.js';
export const command = {
    ...
    run: async (client, interaction, lang, command, neededPerm) => {
        ...
        if (cooldown !== null && timeout - (Date.now() - cooldown) > 0) {
            ...
            await client.channels.cache.get(client.config.core.reportChannelID).send({ embeds: [embed] });
